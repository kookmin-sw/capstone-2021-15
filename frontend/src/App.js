...
import RecommendFeedbackPage from "./views/RecommendFeedbackPage/RecommendFeedbackPage";
    ...
    return (
        <Router>
            <div className="App" style={{ paddingTop: '69px', minHeight: 'calc(100vh - 80px)' }}>
                ...
                <Route exact path="/feedback" component={Auth(RecommendFeedbackPage, true)}/>
            </div>
        </Router>
    );
}
